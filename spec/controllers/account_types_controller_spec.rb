...
RSpec.describe AccountTypesController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all account_types as @account_types" do
      ...
      expect(assigns(:account_types)).to eq([account_type])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested account_type as @account_type" do
      ...
      expect(assigns(:account_type)).to eq(account_type)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new account_type as @account_type" do
      ...
      expect(assigns(:account_type)).to be_a_new(AccountType)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created account_type as @account_type" do
        post :create, {:account_type => valid_attributes}, valid_session
        expect(assigns(:account_type)).to be_a(AccountType)
        expect(assigns(:account_type)).to be_persisted
      end

      it "redirects to the created account_type" do
        post :create, {:account_type => valid_attributes}, valid_session
        expect(response).to redirect_to(AccountType.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved account_type as @account_type" do
        post :create, {:account_type => invalid_attributes}, valid_session
        expect(assigns(:account_type)).to be_a_new(AccountType)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested account_type" do
        account_type = AccountType.create! valid_attributes
        put :update, {:id => account_type.to_param, :account_type => new_attributes}, valid_session
        account_type.reload
      ...
      it "redirects to the account_type" do
        account_type = AccountType.create! valid_attributes
        put :update, {:id => account_type.to_param, :account_type => valid_attributes}, valid_session
        expect(response).to redirect_to(account_type)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the account_type as @account_type" do
        account_type = AccountType.create! valid_attributes
        put :update, {:id => account_type.to_param, :account_type => invalid_attributes}, valid_session
        expect(assigns(:account_type)).to eq(account_type)
      end
